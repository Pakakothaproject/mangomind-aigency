    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="container flex-between">
        ...
        <div className="desktop-nav nav-links">
          ...
          <a href="/#about" className="nav-link">{t.nav.whyUs}</a>
        ...
        {isOpen && (
          ...
          >
            <div className="flex-col gap-4">
              ...
              <a href="/#process" className="nav-link" onClick={() => setIsOpen(false)}>{t.nav.process}</a>
              <a href="/#about" className="nav-link" onClick={() => setIsOpen(false)}>{t.nav.whyUs}</a>
